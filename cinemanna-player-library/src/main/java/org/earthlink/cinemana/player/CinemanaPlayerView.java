...
public final class CinemanaPlayerView extends FrameLayout {
    ...
    public CinemanaPlayerView(Context context) {
        this(context, null);
    }

    public CinemanaPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CinemanaPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        controller = (CinemanaPlaybackControlView) findViewById(R.id.control);
        controller.hide();
    ...
    public CinemanaPlaybackControlView getController() {
        return controller;
    }
     ...
     */
    public void setControllerVisibilityListener(CinemanaPlaybackControlView.VisibilityListener listener) {
