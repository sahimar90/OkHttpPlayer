...
import static org.earthlink.cinemana.player.R.id.showHideSubs;

/**
 * A view to control video playback of an {@link ExoPlayer}.
 */
public class CinemanaPlaybackControlView extends FrameLayout {
    ...
    public CinemanaPlaybackControlView(Context context) {
        this(context, null);
    }

    public CinemanaPlaybackControlView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CinemanaPlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
