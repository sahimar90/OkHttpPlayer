 ...
 */
@TargetApi(16)
public final class OkHttpPlayerView extends FrameLayout {

    private final View surfaceView;
    private final View shutterView;
    private final SubtitleView subtitleLayout;
    private final AspectRatioFrameLayout layout;
    private final OkPlaybackControlView controller;
    ...
    public OkHttpPlayerView(Context context) {
        this(context, null);
    }

    public OkHttpPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OkHttpPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.okhttp_player_view, this);
        ...
        controller = (OkPlaybackControlView) findViewById(R.id.control);
        controller.hide();
    ...
    public OkPlaybackControlView getController() {
        return controller;
    }
     ...
     */
    public void setControllerVisibilityListener(OkPlaybackControlView.VisibilityListener listener) {
