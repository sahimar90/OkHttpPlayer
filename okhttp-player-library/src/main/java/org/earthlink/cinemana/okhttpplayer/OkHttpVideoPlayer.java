 ...
 */
public class OkHttpVideoPlayer extends Activity implements View.OnClickListener, ExoPlayer.EventListener,
        OkPlaybackControlView.VisibilityListener, TextRenderer.Output {


    private static final String TAG = OkHttpVideoPlayer.class.getSimpleName();
...
//    private ProgressBar circleProgress;
    ...
    private OkHttpPlayerView okHttpPlayerView;
...
//        });
        ...
        okHttpPlayerView = (OkHttpPlayerView) findViewById(R.id.player_view);
        okHttpPlayerView.setControllerVisibilityListener(this);
        okHttpPlayerView.requestFocus();
...
//            trackSelector.addListener(eventLogger);
            ...
            // CONTROLLER
            okHttpPlayerView.setPlayer(player);
            ...
            okHttpPlayerView.getController().setVideoData(videoFile, trackSelector);
            okHttpPlayerView.getController().setDecorView(getWindow().getDecorView());


            if (videoFile.arTranslationFilePath.contains(".srt")) {
                okHttpPlayerView.getController().setSubtitleLayout(subtitleLayout);
            }
